...
def plot_difference(H, t_final =1.): #plots the energy difference for h=1/(10H) to h=1/H
	...
	plt.show()
	slope_euler = (np.log10(diff_en_E[10])-np.log10(diff_en_E[0]))/(np.log10(axis[10])-np.log10(axis[0]))
	slope_verlet = (np.log10(diff_en_V[10])-np.log10(diff_en_V[0]))/(np.log10(axis[10])-np.log10(axis[0]))
	print(slope_euler, slope_verlet)
